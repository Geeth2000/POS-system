...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="flex flex-col w-20 bg-indigo-600 dark:bg-slate-800 shadow-xl flex-shrink-0 transition-colors">
        ...
        <nav class="flex-1 flex flex-col items-center py-4 gap-2">
            ...
            <a href="{{ route(auth()->user()->isCashier() ? 'cashier.dashboard' : 'dashboard') }}" id="navDashboard" class="nav-item w-14 h-14 rounded-xl flex flex-col items-center justify-center gap-1 text-indigo-200 hover:text-white cursor-pointer" title="Dashboard">
            ...
            @if(Auth::user()->canManageUsers())
                <a href="{{ route('users.index') }}" id="navStaff" class="nav-item w-14 h-14 rounded-xl flex flex-col items-center justify-center gap-1 text-indigo-200 hover:text-white cursor-pointer" title="Staff">
